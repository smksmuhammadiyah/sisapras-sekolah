  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        <DropdownMenuSeparator />
        {(!summary || (summary.lowStock === 0 && summary.pendingProcurements === 0 && summary.unapprovedUsers === 0 && summary.activeLendings === 0)) && (
        ...
        {summary && summary.unapprovedUsers > 0 && (
          <DropdownMenuItem asChild>
        ...
        {summary && summary.activeLendings > 0 && (
          <DropdownMenuItem asChild>
        ...
        {totalUnread === 0 && summary && (summary.lowStock > 0 || summary.pendingProcurements > 0 || summary.unapprovedUsers > 0 || summary.activeLendings > 0) && (
